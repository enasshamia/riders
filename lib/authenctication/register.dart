...
import 'package:lhad_albiet_riders/widgets/custom_text_field.dart';
import 'package:lhad_albiet_riders/widgets/error_dialog.dart';
import 'package:lhad_albiet_riders/widgets/loading_dialog.dart';
    ...
    if(imageXFile == null)
      ...
      if(passwordController.text == confirmPasswordController.text){
        ...
        if(confirmPasswordController.text.isNotEmpty && emailController.text.isNotEmpty && nameController.text.isNotEmpty && phoneController.text.isNotEmpty && locationController.text.isNotEmpty){
          ...
          fStorge.Reference reference = fStorge.FirebaseStorage.instance.ref().child("riders").child(fileName);
